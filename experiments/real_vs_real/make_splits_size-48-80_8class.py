...
data_root = '../../data'
data_paths = ['LIN_Normalized_WT_size-48-80_8class_train',
              'LIN_Normalized_WT_size-48-80_8class_test']
target_folders = ['LIN_Normalized_WT_size-48-80_8class_train_splits',
                  'LIN_Normalized_WT_size-48-80_8class_test_splits']
